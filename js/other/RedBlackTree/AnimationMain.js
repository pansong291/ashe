...
function returnSubmit(field, funct, maxsize, intOnly) {
    ...
    return function (event) {
        ...
        if (keyASCII == 13) {
            ...
            if (keyASCII == 59 || keyASCII == 45 || keyASCII == 46 || keyASCII == 190 || keyASCII == 173) {
                return false
            } else {
                if (maxsize != undefined && field.value.length >= maxsize || intOnly && (keyASCII < 48 || keyASCII > 57)) {
...
function animWaiting() {
    ...
    objectManager.statusReport.setText("动画暂停/Animation Paused");
...
function animStarted() {
    ...
    objectManager.statusReport.setText("动画运行中/Animation Running");
...
function animEnded() {
    ...
    objectManager.statusReport.setText("动画完成/Animation Completed");
...
function doPlayPause() {
    paused = !paused;
    if (paused) {
        playPauseBackButton.setAttribute("value", "运行/run");
        if (skipBackButton.disabled == false) {
            stepBackButton.disabled = false
        }
    } else {
        playPauseBackButton.setAttribute("value", "调试/debug")
    }
...
function initCanvas() {
    ...
    skipBackButton = addControlToAnimationBar("Button", "返回/Skip Back");
    skipBackButton.onclick = animationManager.skipBack.bind(animationManager);
    stepBackButton = addControlToAnimationBar("Button", "退一步/Step Back");
    stepBackButton.onclick = animationManager.stepBack.bind(animationManager);
    playPauseBackButton = addControlToAnimationBar("Button", "调试/debug");
    playPauseBackButton.onclick = doPlayPause;
    stepForwardButton = addControlToAnimationBar("Button", "进一步/Step Forward");
    stepForwardButton.onclick = animationManager.step.bind(animationManager);
    skipForwardButton = addControlToAnimationBar("Button", "前进/Skip Forward");
    ...
    var txtNode = document.createTextNode("动画速度/Animation Speed");
    midLevel.appendChild(bottomLevel);
    ...
    $(element).slider({
        animate: true, value: speed, change: function (e, ui) {
    ...
    txtNode = document.createTextNode(" 宽/w:");
    ...
    tableEntry = document.createElement("td");
    txtNode = document.createTextNode("       高/h:");
    tableEntry.appendChild(txtNode);
    controlBar.appendChild(tableEntry);
    ...
    sizeButton = addControlToAnimationBar("Button", "改变画布大小/Change Canvas Size");
    sizeButton.onclick = animationManager.changeSize.bind(animationManager);
    swapButton = addControlToAnimationBar("Button", "移动控制栏/Move Controls");
...
function AnimationManager(objectManager) {
    ...
    this.startNextBlock = function () {
        ...
        while (this.currentAnimation < this.AnimationSteps.length && !foundBreak) {
            ...
            if (nextCommand[0].toUpperCase() == "CREATECIRCLE") {
                ...
                if (nextCommand[0].toUpperCase() == "CONNECT") {
                            ...
                            if (nextCommand.length > 5) {
                                ...
                                if (nextCommand.length > 4) {
                                    ...
                                    if (nextCommand.length > 3) {
                                        this.animatedObjects.connectEdge(parseInt(nextCommand[1]), parseInt(nextCommand[2]), this.parseColor(nextCommand[3]), 0, true, "", 0)
                                    } else {
                                        this.animatedObjects.connectEdge(parseInt(nextCommand[1]), parseInt(nextCommand[2]), "#000000", 0, true, "", 0)
                                    }
                                }
                            }
                        }
                    ...
                    if (nextCommand[0].toUpperCase() == "CREATERECTANGLE") {
                        ...
                        if (nextCommand[0].toUpperCase() == "MOVE") {
                            var objectID = parseInt(nextCommand[1]);
                            var nextAnim = new SingleAnimation(objectID, this.animatedObjects.getNodeX(objectID), this.animatedObjects.getNodeY(objectID), parseInt(nextCommand[2]), parseInt(nextCommand[3]));
                            ...
                            if (nextCommand[0].toUpperCase() == "MOVETOALIGNRIGHT") {
                                ...
                                var nextAnim = new SingleAnimation(id, this.animatedObjects.getNodeX(id), this.animatedObjects.getNodeY(id), newXY[0], newXY[1]);
                                this.currentBlock.push(nextAnim);
                                undoBlock.push(new UndoMove(nextAnim.objectID, nextAnim.toX, nextAnim.toY, nextAnim.fromX, nextAnim.fromY));
                                anyAnimations = true
                            } else {
                                if (nextCommand[0].toUpperCase() == "STEP") {
                                    foundBreak = true
                                } else {
                                    if (nextCommand[0].toUpperCase() == "SETFOREGROUNDCOLOR") {
                                        var id = parseInt(nextCommand[1]);
                                        ...
                                        if (nextCommand[0].toUpperCase() == "SETBACKGROUNDCOLOR") {
                                            ...
                                            if (nextCommand[0].toUpperCase() == "SETHIGHLIGHT") {
                                                ...
                                                if (nextCommand[0].toUpperCase() == "DISCONNECT") {
                                                    ...
                                                    if (nextCommand[0].toUpperCase() == "SETALPHA") {
                                                        ...
                                                        if (nextCommand[0].toUpperCase() == "SETTEXT") {
                                                            if (nextCommand.length > 3) {
                                                            ...
                                                            if (nextCommand[0].toUpperCase() == "DELETE") {
                                                                var objectID = parseInt(nextCommand[1]);
                                                                var i;
                                                                ...
                                                                if (nextCommand[0].toUpperCase() == "CREATEHIGHLIGHTCIRCLE") {
                                                                    if (nextCommand.length > 5) {
                                                                    ...
                                                                    if (nextCommand[0].toUpperCase() == "CREATELABEL") {
                                                                        if (nextCommand.length == 6) {
                                                                        ...
                                                                        if (nextCommand[0].toUpperCase() == "SETEDGECOLOR") {
                                                                            ...
                                                                            if (nextCommand[0].toUpperCase() == "SETEDGEALPHA") {
                                                                                var from = parseInt(nextCommand[1]);
                                                                                var to = parseInt(nextCommand[2]);
                                                                                ...
                                                                                if (nextCommand[0].toUpperCase() == "SETEDGEHIGHLIGHT") {
                                                                                    ...
                                                                                    if (nextCommand[0].toUpperCase() == "SETHEIGHT") {
                                                                                        id = parseInt(nextCommand[1]);
                                                                                        ...
                                                                                        if (nextCommand[0].toUpperCase() == "SETLAYER") {
                                                                                            this.animatedObjects.setLayer(parseInt(nextCommand[1]), parseInt(nextCommand[2]))
                                                                                        } else {
                                                                                            if (nextCommand[0].toUpperCase() == "CREATELINKEDLIST") {
                                                                                                ...
                                                                                                if (nextCommand[0].toUpperCase() == "SETNULL") {
                                                                                                    ...
                                                                                                    if (nextCommand[0].toUpperCase() == "SETTEXTCOLOR") {
                                                                                                        if (nextCommand.length > 3) {
                                                                                                        ...
                                                                                                        if (nextCommand[0].toUpperCase() == "CREATEBTREENODE") {
                                                                                                            this.animatedObjects.addBTreeNode(parseInt(nextCommand[1]), parseFloat(nextCommand[2]), parseFloat(nextCommand[3]), parseInt(nextCommand[4]), this.parseColor(nextCommand[7]), this.parseColor(nextCommand[8]));
                                                                                                            this.animatedObjects.setNodePosition(parseInt(nextCommand[1]), parseInt(nextCommand[5]), parseInt(nextCommand[6]));
                                                                                                            undoBlock.push(new UndoCreate(parseInt(nextCommand[1])))
                                                                                                        } else {
                                                                                                            if (nextCommand[0].toUpperCase() == "SETWIDTH") {
                                                                                                                var id = parseInt(nextCommand[1]);
                                                                                                                ...
                                                                                                                if (nextCommand[0].toUpperCase() == "SETNUMELEMENTS") {
                                                                                                                    ...
                                                                                                                    if (nextCommand[0].toUpperCase() == "SETPOSITION") {
                                                                                                                        var id = parseInt(nextCommand[1]);
                                                                                                                        ...
                                                                                                                        if (nextCommand[0].toUpperCase() == "ALIGNRIGHT") {
                                                                                                                            var id = parseInt(nextCommand[1]);
                                                                                                                            var oldX = this.animatedObjects.getNodeX(id);
                                                                                                                            var oldY = this.animatedObjects.getNodeY(id);
                                                                                                                            undoBlock.push(new UndoSetPosition(id, oldX.oldY));
                                                                                                                            ...
                                                                                                                            if (nextCommand[0].toUpperCase() == "ALIGNLEFT") {
                                                                                                                                var id = parseInt(nextCommand[1]);
                                                                                                                                var oldX = this.animatedObjects.getNodeX(id);
                                                                                                                                var oldY = this.animatedObjects.getNodeY(id);
                                                                                                                                undoBlock.push(new UndoSetPosition(id, oldX.oldY));
                                                                                                                                ...
                                                                                                                                if (nextCommand[0].toUpperCase() == "ALIGNTOP") {
                                                                                                                                    var id = parseInt(nextCommand[1]);
                                                                                                                                    var oldX = this.animatedObjects.getNodeX(id);
                                                                                                                                    var oldY = this.animatedObjects.getNodeY(id);
                                                                                                                                    undoBlock.push(new UndoSetPosition(id, oldX.oldY));
                                                                                                                                    ...
                                                                                                                                    if (nextCommand[0].toUpperCase() == "ALIGNBOTTOM") {
                                                                                                                                        var id = parseInt(nextCommand[1]);
                                                                                                                                        var oldX = this.animatedObjects.getNodeX(id);
                                                                                                                                        var oldY = this.animatedObjects.getNodeY(id);
                                                                                                                                        undoBlock.push(new UndoSetPosition(id, oldX.oldY));
                                                                                                                                        ...
                                                                                                                                        if (nextCommand[0].toUpperCase() == "SETHIGHLIGHTINDEX") {
                                                                                                                                            var id = parseInt(nextCommand[1]);
    ...
    this.stepBack = function () {
        if (this.awaitingStep && this.undoStack != null && this.undoStack.length != 0) {
            ...
            if (!this.currentlyAnimating && this.animationPaused && this.undoAnimationStepIndices != null) {
                this.fireEvent("AnimationStarted", "NoData");
                this.currentlyAnimating = true;
                this.undoLastBlock();
                clearTimeout(timer);
